...
from .models import (
    AnalysisResult, Artifact, ConversationMessage, Critique, DatasetReference,
    FinalResponse, Interpretation, Plan, PreprocessingReport, RunControl, WarningEvent,
)
...
def create_initial_state(
    ...
    *,
    ...
    return AgentState(
        ...
        conversation_context=[m.model_copy(deep=True) for m in conversation_context or []],
